...
-----------------------------------------------------------
   ...
   and MAPCAM frames were provided in [16]:
   ...
   The Samcam DCM from [9] and Polycam and Mapcam DCMs from [16] are
   incorporated in the definitions below.
